...
const NotificationTray: React.FC = () => {
  const [selectedNotificationView, setSelectedNotificationView] =
    useState('All');

  return (
    <div className="notification-tray-container">
      <h3 className="text-black pt-3">Notifications</h3>
      <div className="btn-group ps-3 pe-3">
        <button
          className={
            selectedNotificationView === 'All'
        ...
        <button
          className={
            selectedNotificationView === 'Scheduled'
              ? 'btn btn-outline-primary active'
              : 'btn btn-outline-primary'
          }
        ...
        <button
          className={
            selectedNotificationView === 'Pending'
              ? 'btn btn-outline-primary active'
              : 'btn btn-outline-primary'
          }
        ...
        <button
          className={
            selectedNotificationView === 'Rescheduled'
              ? 'btn btn-outline-primary active'
              : 'btn btn-outline-primary'
          }
